...
// You will want to create a separate class for com.company.Contacts (name and phone number).
// Create a master class (MobilePhone) that holds the ArrayList of com.company.Contacts
